...
class Safety:
    ...
    def make_vote(self, P, b, last_tc, node_id, signature):
        ...
        if self.__safe_to_vote(b.round, qc_round, last_tc):
            ...
            ledger_commit_info = LedgerCommitInfo(commit_state_id = self.__commit_state_id_candidate(b.round, b.qc), vote_info_hash = Hashing.temphash(vote_info))
    ...
    def make_timeout(self, round, high_qc, last_tc, node_id, signature):
        ...
        if self.__safe_to_timeout(round, qc_round, last_tc):
            ...
            return TimeoutInfo(round, high_qc, node_id, signature)
        return None
